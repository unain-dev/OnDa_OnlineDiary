package com.ssafy.onda.global.error;

import com.ssafy.onda.global.error.dto.ErrorResponseDto;
import com.ssafy.onda.global.error.dto.ErrorStatus;
import com.ssafy.onda.global.error.exception.BusinessException;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponseDto> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        final ErrorResponseDto response = ErrorResponseDto.of(ErrorStatus.INVALID_INPUT_VALUE);
    ...
    protected ResponseEntity<ErrorResponseDto> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e) {
        ...
        final ErrorResponseDto response = ErrorResponseDto.of(ErrorStatus.METHOD_NOT_ALLOWED);
    ...
    protected ResponseEntity<ErrorResponseDto> handleAccessDeniedException(AccessDeniedException e) {
        ...
        final ErrorResponseDto response = ErrorResponseDto.of(ErrorStatus.HANDLE_ACCESS_DENIED);
        return new ResponseEntity<>(response, HttpStatus.valueOf(ErrorStatus.HANDLE_ACCESS_DENIED.getStatus()));
    }
